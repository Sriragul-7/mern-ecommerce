        ...
        <nav className="flex flex-wrap items-center gap-5">
          ...
          {isAdmin && (
            <Link className="bg-emerald-700 hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center"
             to={"/secret-dashboard"} > <Lock className="inline-block mr-1" size={18} />
          ...
          {user? (
            ...
            >
              ...
              <>
              <Link to={"/signup"} className="bg-gray-700 hover:bg-gray-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center">
              <UserPlus size={18} className="mr-2"/>
              Sign Up
              </Link>

              <Link to={"/login"} className="bg-emerald-700 hover:bg-emerald-600 text-white px-3 py-1 rounded-md font-medium transition duration-300 ease-in-out flex items-center">
