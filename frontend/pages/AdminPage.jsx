...
import CreatePrductForm from "../components/CreateProductForm"
...
const AdminPage = () => {
  ...
  return (
    <div className="min-h-full bg-gray-900 text-white relative overflow-hidden">
      ...
      <div className="flex justify-center mb-4">
        ...
        <div>
          {activeTab === "create" && <CreatePrductForm />}
