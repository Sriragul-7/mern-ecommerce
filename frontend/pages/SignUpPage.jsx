...
const SignUpPage = () => {
  ...
  return (
    <div className='flex justify-center flex-col py-12 sm:px-6 lg:px-8'>
      ...
      >
        <h2 className="mt-6 text-center text-3xl font-extrabold text-emerald-400 mb-7">Create your account</h2>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <div className="mt-1 relative rouded-md shadow-sm">
            ...
            className="block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:"
            placeholder=" Sri Ragul"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          Login hear <ArrowRight className="inline size-4"/>
          </Link>
        </p>
        </div>
